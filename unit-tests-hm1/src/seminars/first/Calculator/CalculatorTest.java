...
//        ).isInstanceOf(IllegalStateException.class);
        ...
        Assertions.assertThatThrownBy(()-> Calculator.calculatingDiscount(-3.0,75))
                .isInstanceOf(ArithmeticException.class)
                .hasMessage("Сумма покупки должна быть больше или равна 0");
        Assertions.assertThatThrownBy(()-> Calculator.calculatingDiscount(3.0,-4))
                .isInstanceOf(ArithmeticException.class)
                .hasMessage("Сумма скидки должна быть в пределах от 0 до 100");
        Assertions.assertThatThrownBy(()-> Calculator.calculatingDiscount(3.0,101))
                .isInstanceOf(ArithmeticException.class)
                .hasMessage("Сумма скидки должна быть в пределах от 0 до 100");



        Assertions.assertThat(Calculator.calculatingDiscount(100.0, 25)).isEqualTo(75.0);
        Assertions.assertThat(Calculator.calculatingDiscount(100.0, 100)).isEqualTo(0.0);
        Assertions.assertThat(Calculator.calculatingDiscount(100.0, 0)).isEqualTo(100.0);
    }
}